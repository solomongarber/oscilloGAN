...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--input_nz', type=int, default=0, help='dimension of the auxilliary conditionals')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='aligned', help='aligned,single,npz')
