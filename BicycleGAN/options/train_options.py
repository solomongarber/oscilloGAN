...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_G2',type=float,default=0.0,help='weight on the accuracy of the predicted frequency')
        ...
        self.parser.add_argument('--use_mse', action='store_true',help='sets data reconstruction term to L2 loss (instead of L1)')
        self.isTrain = True
